import { BadRequestException, CanActivate, ExecutionContext, Injectable, ForbiddenException, HttpStatus, HttpException } from '@nestjs/common';
...
export class RolesGuard implements CanActivate {
	...
	async canActivate(context: ExecutionContext | any): Promise<boolean> {
		...
		throw new HttpException('Only GraphQL is supported', HttpStatus.INTERNAL_SERVER_ERROR);
	}
}
